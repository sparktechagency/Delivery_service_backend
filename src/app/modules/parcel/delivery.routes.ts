...
import { requestToDeliver, acceptDeliveryOffer, updateParcelStatus, postReviewForUser, getReviewsForUser, cancelDeliveryRequest, cancelParcelDelivery, getAllCompletedParcels } from './delivery.controller';
...
deliveryRouter.get('/all-deliverd_parcels', getAllCompletedParcels);
